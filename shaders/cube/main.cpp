...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(winW, winH, "Cube - Diffuse Shader", nullptr, nullptr);
    if (!window) {
    ...
    Vec3 objectColor = {0.4f, 0.6f, 0.9f};
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glUniform3f(locObjCol, objectColor.x, objectColor.y, objectColor.z);
